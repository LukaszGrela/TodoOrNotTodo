...
public class SupportSquidCursorLoader<T extends AbstractModel> extends AsyncTaskLoader<SquidCursor<T>> {
    ...
    public SupportSquidCursorLoader(Context context, DatabaseDao dao, Class<T> modelClass, Query query) {
        super(context);
        this.dao = dao;
        this.query = query;
